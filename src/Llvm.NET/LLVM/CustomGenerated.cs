...
namespace Llvm.NET.Native
{
    ...
    internal static partial class NativeMethods
    {
        ...
        internal static extern void GetVersionInfo( ref LLVMVersionInfo pVersionInfo );
        ...
        internal static extern LLVMValueRef BuildIntCast( LLVMBuilderRef @param0, LLVMValueRef @Val, LLVMTypeRef @DestTy, LLVMBool isSigned, [MarshalAs( UnmanagedType.LPStr )] string @Name );
        ...
        internal static extern LLVMBool VerifyFunctionEx( LLVMValueRef @Fn, LLVMVerifierFailureAction @Action, [MarshalAs( UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof( MessageMarshaler ) )] out string @OutMessages );
        ...
        internal static extern IntPtr GetMDStringText( LLVMMetadataRef M, out UInt32 len );
        ...
        [DllImport( libraryPath, EntryPoint = "LLVMFunctionHasPersonalityFunction", CallingConvention = CallingConvention.Cdecl, BestFitMapping = false, ThrowOnUnmappableChar = true )]
        ...
        internal static extern LLVMBool TripleOpEqual( LLVMTripleRef lhs, LLVMTripleRef rhs );
        ...
        internal static extern LLVMBool TripleHasEnvironment( LLVMTripleRef triple );
