...
namespace Llvm.NET.Native
{
    ...
    internal enum LLVMVerifierFailureAction : int
    {
    ...
    internal enum LLVMTypeKind : int
    {
        @LLVMVoidTypeKind = 0,
        @LLVMHalfTypeKind = 1,
        @LLVMFloatTypeKind = 2,
    ...
    internal enum LLVMVisibility : int
    {
    ...
    internal enum LLVMDLLStorageClass : int
    {
    ...
    internal enum LLVMCallConv : int
    {
        @LLVMCCallConv = 0,
        @LLVMFastCallConv = 8,
        @LLVMColdCallConv = 9,
    ...
    internal enum LLVMIntPredicate : int
    {
        @LLVMIntEQ = 32,
        @LLVMIntNE = 33,
        @LLVMIntUGT = 34,
    ...
    internal enum LLVMRealPredicate : int
    {
    ...
    internal enum LLVMLandingPadClauseTy : int
    {
        @LLVMLandingPadCatch = 0,
        @LLVMLandingPadFilter = 1,
    }

    internal enum LLVMThreadLocalMode : int
    {
    ...
    internal enum LLVMAtomicOrdering : int
    {
    ...
    internal enum LLVMAtomicRMWBinOp : int
    {
    ...
    internal enum LLVMDiagnosticSeverity : int
    {
        @LLVMDSError = 0,
        @LLVMDSWarning = 1,
        @LLVMDSRemark = 2,
    ...
    internal enum LLVMAttributeIndex : int
    {
        @LLVMAttributeReturnIndex = 0,
        @LLVMAttributeFunctionIndex = -1,
    }

    internal enum LLVMByteOrdering : int
    {
        @LLVMBigEndian = 0,
        @LLVMLittleEndian = 1,
    }

    internal enum LLVMCodeGenOptLevel : int
    {
    ...
    internal enum LLVMRelocMode : int
    {
        @LLVMRelocDefault = 0,
        @LLVMRelocStatic = 1,
        @LLVMRelocPIC = 2,
    ...
    internal enum LLVMCodeModel : int
    {
    ...
    internal enum LLVMCodeGenFileType : int
    {
        @LLVMAssemblyFile = 0,
        @LLVMObjectFile = 1,
    }

    internal enum LLVMLinkerMode : int
    {
        @LLVMLinkerDestroySource = 0,
        @LLVMLinkerPreserveSource_Removed = 1,
    }

    internal enum llvm_lto_status : int
    {
        @LLVM_LTO_UNKNOWN = 0,
    ...
    internal enum lto_symbol_attributes : int
    {
    ...
    internal enum lto_debug_model : int
    {
        @LTO_DEBUG_MODEL_NONE = 0,
        @LTO_DEBUG_MODEL_DWARF = 1,
    }

    internal enum lto_codegen_model : int
    {
    ...
    internal enum lto_codegen_diagnostic_severity_t : int
    {
        @LTO_DS_ERROR = 0,
        @LTO_DS_WARNING = 1,
        @LTO_DS_REMARK = 3,
    ...
    internal enum LLVMOrcErrorCode : int
    {
        @LLVMOrcErrSuccess = 0,
        @LLVMOrcErrGeneric = 1,
    }
    ...
    internal static partial class NativeMethods
    {
        ...
        // return is Success(0)/fail(!0) and not an actual bool
        internal static extern LLVMBool VerifyModule( LLVMModuleRef @M, LLVMVerifierFailureAction @Action, [MarshalAs( UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof( MessageMarshaler ) )] out string @OutMessage );
        ...
        internal static extern LLVMBool ParseBitcode2( LLVMMemoryBufferRef @MemBuf, out LLVMModuleRef @OutModule );

        [DllImport( libraryPath, EntryPoint = "LLVMParseBitcodeInContext", CallingConvention = CallingConvention.Cdecl )]
        internal static extern LLVMBool ParseBitcodeInContext( LLVMContextRef @ContextRef, LLVMMemoryBufferRef @MemBuf, out LLVMModuleRef @OutModule, [MarshalAs( UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof( MessageMarshaler ) )] out string @OutMessage );

        [DllImport( libraryPath, EntryPoint = "LLVMParseBitcodeInContext2", CallingConvention = CallingConvention.Cdecl )]
        internal static extern LLVMBool ParseBitcodeInContext2( LLVMContextRef @ContextRef, LLVMMemoryBufferRef @MemBuf, out LLVMModuleRef @OutModule );
        ...
        internal static extern LLVMBool GetBitcodeModuleInContext2( LLVMContextRef @ContextRef, LLVMMemoryBufferRef @MemBuf, out LLVMModuleRef @OutM );
        ...
        internal static extern LLVMBool GetBitcodeModule2( LLVMMemoryBufferRef @MemBuf, out LLVMModuleRef @OutM );
        ...
        [return: MarshalAs( UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof( MessageMarshaler ) )]
        ...
        internal static extern IntPtr GetStringAttributeKind( LLVMAttributeRef @A, out uint @Length );

        [DllImport( libraryPath, EntryPoint = "LLVMGetStringAttributeValue", CallingConvention = CallingConvention.Cdecl )]
        internal static extern IntPtr GetStringAttributeValue( LLVMAttributeRef @A, out uint @Length );

        [DllImport( libraryPath, EntryPoint = "LLVMIsEnumAttribute", CallingConvention = CallingConvention.Cdecl )]
        internal static extern LLVMBool IsEnumAttribute( LLVMAttributeRef @A );

        [DllImport( libraryPath, EntryPoint = "LLVMIsStringAttribute", CallingConvention = CallingConvention.Cdecl )]
        internal static extern LLVMBool IsStringAttribute( LLVMAttributeRef @A );
        ...
        internal static extern LLVMBool PrintModuleToFile( LLVMModuleRef @M, [MarshalAs( UnmanagedType.LPStr )] string @Filename, [MarshalAs( UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof( MessageMarshaler ) )] out string @ErrorMessage );
        ...
        internal static extern IntPtr GetAsString( LLVMValueRef @c, out size_t @Length );
        ...
        internal static extern LLVMBool HasPersonalityFn( LLVMValueRef @Fn );
        ...
        internal static extern IntPtr GetBasicBlockName( LLVMBasicBlockRef @BB );
        ...
        internal static extern LLVMBool IsInBounds( LLVMValueRef @GEP );

        [DllImport( libraryPath, EntryPoint = "LLVMSetIsInBounds", CallingConvention = CallingConvention.Cdecl )]
        internal static extern void SetIsInBounds( LLVMValueRef @GEP, LLVMBool @InBounds );
        ...
        internal static extern LLVMBool IsCleanup( LLVMValueRef @LandingPad );
        ...
        internal static extern LLVMBool IsAtomicSingleThread( LLVMValueRef @AtomicInst );

        [DllImport( libraryPath, EntryPoint = "LLVMSetAtomicSingleThread", CallingConvention = CallingConvention.Cdecl )]
        internal static extern void SetAtomicSingleThread( LLVMValueRef @AtomicInst, LLVMBool @SingleThread );
        ...
        internal static extern LLVMBool CreateMemoryBufferWithContentsOfFile( [MarshalAs( UnmanagedType.LPStr )] string @Path, out LLVMMemoryBufferRef @OutMemBuf, [MarshalAs( UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof( MessageMarshaler ) ) ]out string @OutMessage );
        ...
        internal static extern LLVMMemoryBufferRef CreateMemoryBufferWithMemoryRange( [MarshalAs( UnmanagedType.LPStr )] string @InputData, size_t @InputDataLength, [MarshalAs( UnmanagedType.LPStr )] string @BufferName, LLVMBool @RequiresNullTerminator );
        ...
        internal static extern LLVMBool GetTargetFromTriple( [MarshalAs( UnmanagedType.LPStr )] string @Triple, out LLVMTargetRef @T, [MarshalAs( UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof( MessageMarshaler ) )] out string @ErrorMessage );
        ...
        internal static extern LLVMBool TargetMachineEmitToFile( LLVMTargetMachineRef @T, LLVMModuleRef @M, string @Filename, LLVMCodeGenFileType @codegen, [MarshalAs( UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof( MessageMarshaler ) )] out string @ErrorMessage );

        [DllImport( libraryPath, EntryPoint = "LLVMTargetMachineEmitToMemoryBuffer", CallingConvention = CallingConvention.Cdecl )]
        internal static extern LLVMBool TargetMachineEmitToMemoryBuffer( LLVMTargetMachineRef @T, LLVMModuleRef @M, LLVMCodeGenFileType @codegen, [MarshalAs( UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof( MessageMarshaler ) )] out string @ErrorMessage, out LLVMMemoryBufferRef @OutMemBuf );
        ...
        internal static extern LLVMBool CreateMCJITCompilerForModule( out LLVMExecutionEngineRef @OutJIT, LLVMModuleRef @M, out LLVMMCJITCompilerOptions @Options, size_t @SizeOfOptions, out IntPtr @OutError );
        ...
        internal static extern LLVMBool LinkModules2( LLVMModuleRef @Dest, LLVMModuleRef @Src );
